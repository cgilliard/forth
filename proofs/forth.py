...
def main():
    ...
    # ═══════════════════════════════════════════════════════════
    # Chain-based verification: simulate fam3 on forth.fam3 (using the
    # shared assembler model in proofs/fam3_asm.py) and verify the output
    # byte-for-byte against bin/forth. Closes the chain for forth — mirrors
    # fam0(fam1.fam0)==bin/fam1, fam1(fam2.fam1)==bin/fam2, etc.
    ...
    if not (os.path.exists(fam3_bin_path) and os.path.exists(forth_src_path)):
        ...
        fam3_mnem_table, fam3_reg_table = parse_fam3_tables(fam3_binary)
        ...
        fam3_output = sim_fam3(forth_src, fam3_mnem_table, fam3_reg_table)
